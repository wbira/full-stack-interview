...
Good example of implementation Object Pool pattern is  <a href"https://docs.microsoft.com/en-us/dotnet/api/system.threading.threadpool?view=netframework-4.7.2">Thread pool from .NET Framework.</a>
</details>
